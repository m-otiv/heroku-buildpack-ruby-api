...
This is a fork of the official [Heroku Buildpack](http://devcenter.heroku.com/articles/buildpacks) for Ruby, Rack, and Rails apps but without the assets precompile. It uses [Bundler](https://bundler.io) for dependency management.
